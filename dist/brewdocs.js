  ...
  var pages = [
    ...
    // ── FAQ ────────────────────────────────────────────────────
    {
      ...
      html: [
        ...
        '<p>Press the <strong>GREEN</strong> button on your remote while TizenBrew is open to access the',
        'Module Manager. Add any module by entering its GitHub path in <code>user/repo</code> format',
        '(e.g. <code>reisxd/tizentube</code>). Available mods in this wiki: TizenTube, TizenPortal,',
        'TizenBrowse, TFlix, HyperTizen.</p>',
        '<h2>Do I need to manually update TizenTube?</h2>',
        '<p>No. Since TizenBrew <strong>v2.0.2</strong>, modules are updated automatically.',
        'You do not need to re-add or reinstall them.</p>',
        '<h2>How do I reinstall TizenTube after uninstalling it?</h2>',
        '<ol>',
        '  <li>Open TizenBrew → press <strong>GREEN</strong> → Add Module.</li>',
        '  <li>Enter: <code>reisxd/tizentube</code></li>',
        '</ol>',
        '<h2>TizenBrew keeps crashing when I open it</h2>',
        '<p><strong>Reboot your TV</strong> (long-press the power button). Most crash-on-open issues',
        'are caused by stale browser state that a reboot clears.</p>',
        '<h2>I\'m still seeing ads in TizenTube</h2>',
        '<p><strong>Reboot your TV.</strong> The ad-blocker can fall out of sync with YouTube.',
        'A full reboot forces a clean reload.</p>',
        '<h2>4K videos lag or crash</h2>',
        '<p>This is a <strong>known limitation on Tizen 7+</strong> that cannot be fixed by TizenTube.</p>',
        '<table>',
        '  <tr><th>Resolution</th><th>Works?</th></tr>',
        '  <tr><td>Up to 1080p</td><td>✅ Yes</td></tr>',
        '  <tr><td>4K 24/30 fps, non-HDR</td><td>✅ Usually yes</td></tr>',
        '  <tr><td>4K 60 fps / HDR</td><td>❌ Lags / crashes</td></tr>',
        '</table>',
        '<h2>Is TizenBrew available on Android TV?</h2>',
        '<p>No. TizenBrew runs on <strong>Samsung TVs with Tizen OS</strong> only.',
        'For Android / Google TV use <a href="#ttcobalt-overview" class="int-link">TizenTube Cobalt</a> instead.</p>',
        '<h2>Can TizenBrew run native apps or store apps?</h2>',
        '<p>TizenBrew is designed for <strong>web-based apps and site modifications</strong> on Tizen TVs.',
        'Native apps, Samsung store apps, and apps requiring OS-level permissions are out of scope.</p>',
      ].join('\n'),
    },
    ...
    // ── Troubleshooting ────────────────────────────────────────
    {
      ...
      html: [
        ...
        '<p><strong>Cause:</strong> The USB Demo Package installation method is permanently dead.',
        'Samsung shut down the signing service. Any guide mentioning USB installation is outdated.</p>',
        '<p><strong>Fix:</strong> Use the <strong>TizenBrew Installer</strong> desktop app instead.',
        ...
        '<ol>',
        '  <li><strong>Find your TV\'s IP</strong> — go to<br>',
        '  <code>TV Settings → Connection → Network → IP Settings</code><br>',
        '  This is different from the Host PC IP in Developer Mode.</li>',
        '  <li>Confirm <strong>Developer Mode is On</strong> (Apps panel → type <code>12345</code>).</li>',
        '  <li>The <strong>Host PC IP</strong> in Developer Mode is your <em>PC\'s</em> IP, not the TV\'s.</li>',
        '  <li>Try: <code>sdb connect &lt;TV_IP&gt;</code> then <code>sdb devices</code></li>',
        '  <li>Firewall: ensure port <code>26101</code> is not blocked on your PC.</li>',
        '</ol>',
        '<h2>TizenBrew / TizenTube Crashes on Launch</h2>',
        '<p><strong>Fix:</strong> <strong>Reboot your TV</strong> (long-press power / unplug).',
        'If it persists, reinstall TizenBrew via the TizenBrew Installer.</p>',
        '<h2>TizenTube Showing Ads</h2>',
        '<p><strong>Fix:</strong> <strong>Reboot your TV.</strong> If ads continue after several',
        'reboots, check the <a href="https://github.com/reisxd/TizenTube/issues" class="ext-link">TizenTube issue tracker</a>.</p>',
        '<h2>4K Video Playback Issues (Lag or Crashes)</h2>',
        '<p>Known Tizen 7+ limitation, not fixable by TizenTube. Use the native YouTube app for 4K HDR.</p>',
