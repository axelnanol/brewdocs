  ...
  var pages = [
    {
      ...
      html: [
        ...
        '  <li><strong>TizenTube Cobalt</strong> — ad-free YouTube for Android / Google TV</li>',
        '  <li><strong>TizenPortal</strong> — universal browser shell</li>',
        '  <li><strong>More Mods</strong> — TizenBrowse, TFlix, HyperTizen</li>',
        '  <li><strong>Independent Apps</strong> — Jellyfin, Moonlight, Community Packages (not TizenBrew modules)</li>',
    ...
    // ── TizenTube ──────────────────────────────────────────────
    {
      ...
      html: [
        ...
        '  <li><a href="https://github.com/reisxd/TizenTube/issues" class="ext-link">Report Issues</a></li>',
        '</ul>',
      ].join('\n'),
    },
    ...
    // ── TizenPortal ────────────────────────────────────────────
    {
      ...
      html: [
        ...
        '<h2>Community &amp; Support</h2>',
        '<ul>',
        '  <li><a href="https://github.com/axelnanol/tizenportal/issues" class="ext-link">Report Issues</a></li>',
        '</ul>',
      ].join('\n'),
    },
    {
    ...
    // ── TizenBrowse ────────────────────────────────────────────
    {
      ...
      html: [
        ...
        '<h2>Community &amp; Support</h2>',
        '<ul>',
        '  <li><a href="https://github.com/ghostfxck/TizenBrowse/issues" class="ext-link">Report Issues</a></li>',
        '</ul>',
      ].join('\n'),
    },
    ...
    // ── TFlix ──────────────────────────────────────────────────
    {
      ...
      html: [
        ...
        '<h2>Community &amp; Support</h2>',
        '<ul>',
        '  <li><a href="https://github.com/Zyrecx/TFlix/issues" class="ext-link">Report Issues</a></li>',
        '</ul>',
      ].join('\n'),
    },
    ...
    // ── HyperTizen ─────────────────────────────────────────────
    {
      ...
      html: [
        ...
        '<h2>Community &amp; Support</h2>',
        '<ul>',
        '  <li><a href="https://github.com/reisxd/HyperTizen/issues" class="ext-link">Report Issues</a></li>',
        '</ul>',
      ].join('\n'),
    },
